...
var GatewaySecretReferenceGrantAllInNamespace = suite.ConformanceTest{
	...
	Test: func(t *testing.T, s *suite.ConformanceTestSuite) {
		gwNN := types.NamespacedName{Name: "gateway-secret-reference-grant-all", Namespace: "gateway-conformance-infra"}
		...
		t.Run("Gateway listener should have a true ResolvedRefs condition and a true Ready condition", func(t *testing.T) {
			...
			kubernetes.GatewayStatusMustHaveListeners(t, s.Client, gwNN, listeners, s.Timeout)
		})
	},
}
